...
namespace p15controlbancario
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            mibanco.AgregarCliente(new Cliente("Lisett","Lopez"));
            mibanco.AgregarCliente(new Cliente("Damaris","Solis"));
            mibanco.AgregarCliente(new Cliente("Fabiola","Uribe"));
            mibanco.AgregarCliente(new Cliente("Jose","Luna"));
